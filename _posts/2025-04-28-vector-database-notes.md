...
description: "Vector databases are becoming a common backend component for semantic search and RAG systems. The core idea is to retrieve by similarity over embeddings instead of exact..."
---
