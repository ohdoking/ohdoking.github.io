...
description: "LangChain can speed up LLM application experiments, but a production web service still needs normal backend discipline around boundaries, retries, persistence,..."
---
