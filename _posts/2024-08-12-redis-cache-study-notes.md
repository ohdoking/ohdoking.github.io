...
description: "Redis is often introduced as a cache, but production usage also involves data structures, expiration policy, memory limits, replication, and failure behavior."
---
