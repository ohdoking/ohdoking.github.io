...
description: "This note frames a Gen AI app as a cloud system: model access, data flow, identity, storage, deployment, evaluation, and monitoring all need design decisions."
---
