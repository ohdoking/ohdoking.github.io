...
description: "AWS services are easier to reason about when grouped by backend responsibility: compute, storage, networking, messaging, identity, observability, and deployment."
---
